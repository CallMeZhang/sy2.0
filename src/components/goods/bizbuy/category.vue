          ...
          <div class="item-wrapper" v-for="(item, index) in cur_category_sub">
            ...
            <div class="item-content-wrapper">
              ...
              <div style="overflow: hidden;">
                <div class="item-content" v-for="(v, k) in item.subGoodsClassList" @click="appjs.syJsbLaunchWebview(siteInfo.host + '/bizbuy/goods_list?cate_id='+v.gcId + ':' + v.gcName)">
...
<script>
  ...
  export default {
    ...
    methods: {
      initData () {
        bizbuy_category('bizbuy').then((res) => {
      ...
      search() {
        this.$router.push('/bizbuy/goods_list?key=' + this.key)
      }
    }
  }
</script>
